...
require (
	...
	github.com/openshift/api v0.0.0-20240909041644-5852b58f4b10 // release-4.15
	github.com/openshift/cloud-credential-operator v0.0.0-20240228211631-9adc8f69a48c // release-4.15
	github.com/openshift/library-go v0.0.0-20240910113733-b17e2f87dcfa // release-4.15
